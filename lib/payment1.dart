...
class pay1home extends StatefulWidget
{
  @override
...
List<String> res=[];
class _DataFromAPIState extends State<pay1home> {
  final fid="",tid="";
  String date="";
  String slot="";
  String rate="";
  List<String> spinnerItems = ["GK","LB","CB","RB","LF","CF","RF"];
  String selectedSpinnerItem="GK";
  String status="f";
  ...
  Future <void> createData () async
  {
    ...
    String des = prefs.getString('description') ?? 'null' ;
    print(des+"===========================================");
    if(des=="Football 5s")
      {
        if(status=="f")
        setState(() {
          status="t";
          spinnerItems = ["GK", "LB",  "RB", "LF",  "RF"];
          selectedSpinnerItem="GK";
        });
      ...
      setState(() {
        status="t";
        spinnerItems = ["GK", "LB", "CB", "RB", "LF", "CF", "RF"];
        selectedSpinnerItem="GK";
      });
                      ...
                      child: IconButton(
                          ...
                          onPressed: ()async {
                            ...
                            if (!_formKey.currentState!.validate()) {
                              ...
                              var  url ='http://' + ipaddress + ':5000/booknow1?accno=' + accno+"&lid="+ffid+"&ifsc="+ifsc+"&bank="+bank+"&pin="+pin+"&tid="+tid+"&sid="+sid+"&date="+date+"&rate="+rate+"&p="+selectedSpinnerItem+"&des="+des;
